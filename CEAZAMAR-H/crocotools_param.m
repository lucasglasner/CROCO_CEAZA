...
%  Run directory
%
RUN_dir='/home/lucasg/CROCO/CEAZAMAR-H/';
%
...
%
DATADIR='/home/lucas/CROCO/croco_tools/'; 
%
...
%
grdname  = [CROCO_files_dir,'ceazamar_grd.nc'];
frcname  = [CROCO_files_dir,'ceazamar_frc.nc'];
blkname  = [CROCO_files_dir,'ceazamar_blk.nc'];
clmname  = [CROCO_files_dir,'ceazamar_clm.nc'];

bryname  = [CROCO_files_dir,'ceazamar_bry.nc'];
ininame  = [CROCO_files_dir,'ceazamar_ini.nc'];
bioname  = [CROCO_files_dir,'ceazamar_frcbio.nc']; % Iron Dust forcing for PISCES
rivname =  [CROCO_files_dir,'ceazamar_runoff.nc'];
%
% intermediate z-level data files (not used in simulations)
%
oaname   = [CROCO_files_dir,'ceazamar_oa.nc'];    % for climatology data processing
Zbryname = [CROCO_files_dir,'ceazamar_bry_Z.nc']; % for boundary data processing
%
% Generic forcing file root names for interannual simulations (NCEP/GFS)
%
frc_prefix=[CROCO_files_dir,'ceazamar_frc'];      % forcing file name 
blk_prefix=[CROCO_files_dir,'ceazamar_blk'];      % bulk file name
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
%  in the same format)
%
topofile = ['/home/lucasg/storage/GEBCO/GEBCO_2021.nc'];
...
%
bry_prefix  = [CROCO_files_dir,'ceazamar_bry_',OGCM,'_'];    % generic boundary file name
clm_prefix  = [CROCO_files_dir,'ceazamar_clm_',OGCM,'_'];    % generic climatology file name
ini_prefix  = [CROCO_files_dir,'ceazamar_ini_',OGCM,'_'];    % generic initial file name
...
%--------------------------
%
wkb_prefix=[CROCO_files_dir,'ceazamar_wkb'];
wkb_obc= [1 1 1 1];
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
