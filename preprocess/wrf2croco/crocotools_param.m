...
%
CROCO_title  = 'North-Central Chile';
CROCO_config = 'NCCHILEv2';
%
% Grid dimensions:
%
% Grilla 3 km
...
%
hmin = 10;%corlando this doesn't apply to s-coordinate type 2
%
...
%
CROCOTOOLS_dir = '/home/lucasg/CROCO/croco_tools/';
%
%  Run directory
%
RUN_dir='/home/lucasg/CROCO/NCCHILEV2/';
%
...
%
DATADIR='/home/lucasg/CROCO/croco_tools/'; 
%
...
%
grdname  = [CROCO_files_dir,'ncchilev2_grd.nc'];
frcname  = [CROCO_files_dir,'ncchilev2_frc.nc'];
blkname  = [CROCO_files_dir,'ncchilev2_blk.nc'];
clmname  = [CROCO_files_dir,'ncchilev2_clm.nc'];

bryname  = [CROCO_files_dir,'ncchilev2_bry.nc'];
ininame  = [CROCO_files_dir,'ncchilev2_ini.nc'];
bioname  = [CROCO_files_dir,'ncchilev2_frcbio.nc']; % Iron Dust forcing for PISCES
rivname =  [CROCO_files_dir,'ncchilev2_runoff.nc'];
%
% intermediate z-level data files (not used in simulations)
%
oaname   = [CROCO_files_dir,'ncchilev2_oa.nc'];    % for climatology data processing
Zbryname = [CROCO_files_dir,'ncchilev2_bry_Z.nc']; % for boundary data processing
%
% Generic forcing file root names for interannual simulations (NCEP/GFS)
%
frc_prefix=[CROCO_files_dir,'ncchilev2_frc'];      % forcing file name 
blk_prefix=[CROCO_files_dir,'ncchilev2_blk'];      % bulk file name
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
%  in the same format)
%
topofile = ['../BATIMETRIA/GEBCO_08_Aug_2022/gebco_2022_n20.0_s-50.0_w-100.0_e-69.0.nc'];
...
makepisces = 0;   % initial and boundary data for PISCES modelmake
%
%
...
%
Ymin          = 1976;          % first forcing year
Ymax          = 1992;          % last  forcing year
...
%
bry_prefix  = [CROCO_files_dir,'ncchilev2_bry_',OGCM,'_'];    % generic boundary file name
clm_prefix  = [CROCO_files_dir,'ncchilev2_clm_',OGCM,'_'];    % generic climatology file name
ini_prefix  = [CROCO_files_dir,'ncchilev2_ini_',OGCM,'_'];    % generic initial file name
...
%--------------------------
%
wkb_prefix=[CROCO_files_dir,'ncchilev2_wkb'];
wkb_obc= [1 1 1 1];
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
